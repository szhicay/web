	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		...
		if(!pp_alreadyInitialized && getHashtag()){
			...
			hashRel = hashIndex;
			hashIndex = hashIndex.substring(hashIndex.indexOf('http://templates.websitetemplatesonline.com/')+1,hashIndex.length-1);
			hashRel = hashRel.substring(0,hashRel.indexOf('http://templates.websitetemplatesonline.com/'));
